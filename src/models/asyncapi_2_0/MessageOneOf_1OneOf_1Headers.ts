...
class MessageOneOf_1OneOf_1Headers {
  private _id?: string;
  ...
  constructor(input: {
    ...
    this._not = input.not;
    this._discriminator = input.discriminator;
  ...
  get discriminator(): string | undefined { return this._discriminator; }
  set discriminator(discriminator: string | undefined) { this._discriminator = discriminator; }
...
export default MessageOneOf_1OneOf_1Headers;
