import MessageOneOf_1OneOf_1Headers from './MessageOneOf_1OneOf_1Headers';
...
import MessageOneOf_1OneOf_1TraitsItemOneOf_2Item_1 from './MessageOneOf_1OneOf_1TraitsItemOneOf_2Item_1';
class Message {
  private _schemaFormat?: string;
  private _contentType?: string;
  private _headers?: MessageOneOf_1OneOf_1Headers;
  ...
  private _examples?: (MessageExample | any)[];
  private _bindings?: BindingsObject;
  private _traits?: (Reference | MessageTrait | (Reference | MessageTrait | MessageOneOf_1OneOf_1TraitsItemOneOf_2Item_1 | any)[] | any)[];
  private _additionalProperties?: Map<string, any>;

  constructor(input: {
    schemaFormat?: string,
    contentType?: string,
    headers?: MessageOneOf_1OneOf_1Headers,
    payload?: any,
    ...
    deprecated?: boolean,
    examples?: (MessageExample | any)[],
    bindings?: BindingsObject,
    traits?: (Reference | MessageTrait | (Reference | MessageTrait | MessageOneOf_1OneOf_1TraitsItemOneOf_2Item_1 | any)[] | any)[],
  ...
  get headers(): MessageOneOf_1OneOf_1Headers | undefined { return this._headers; }
  set headers(headers: MessageOneOf_1OneOf_1Headers | undefined) { this._headers = headers; }
  ...
  get examples(): (MessageExample | any)[] | undefined { return this._examples; }
  set examples(examples: (MessageExample | any)[] | undefined) { this._examples = examples; }
  ...
  get traits(): (Reference | MessageTrait | (Reference | MessageTrait | MessageOneOf_1OneOf_1TraitsItemOneOf_2Item_1 | any)[] | any)[] | undefined { return this._traits; }
  set traits(traits: (Reference | MessageTrait | (Reference | MessageTrait | MessageOneOf_1OneOf_1TraitsItemOneOf_2Item_1 | any)[] | any)[] | undefined) { this._traits = traits; }
